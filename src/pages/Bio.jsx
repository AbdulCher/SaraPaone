    ...
    <div className="bg-[#121615] text-black">
      ...
      <div className="pt-40 pb-16 text-center px-8">
        <motion.p
          ...
          className="text-xl tracking-[0.4em] uppercase text-[#bea0a4] mb-4"
        >
          Sara Paone
        </motion.p>
        {/*<motion.h1
      ...
      <section className="max-width-[1500px] mx-auto px-8 flex flex-col md:flex-row items-start gap-12 md:gap-20">       <motion.div
          initial={{ opacity: 0, x: 40 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true, amount: 0.2 }}
          transition={{ duration: 0.8, delay: 0.3 }}
          className="w-full md:w-180 shrink-0"
        >
          <img src={piratesofpenzance} alt="Sara Paone" className="w-full h-130 object-cover" />
        </motion.div>

        <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.2 }} className="flex-1 flex flex-col gap-6 text-3xl leading-relaxed text-gray-300">
      ...
      <section style={{ backgroundColor: '#0b0f0d' }} className="py-16 px-8">
        ...
        <div className="max-w-6xl mx-auto gap-12">
          ...
          <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.1 }} className="flex flex-col gap-6 text-2xl text-gray-300 leading-relaxed">
            <p>
          ...
          <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.2 }} className="flex flex-col gap-6 text-2xl text-gray-300 leading-relaxed">
            <p>
          ...
          <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.3 }} className="flex flex-col gap-6 text-2xl text-gray-300 leading-relaxed">
            <p>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex flex-col md:flex-row items-start gap-12 md:gap-20">
            ...
            <motion.div
              ...
              className="flex-1 flex flex-col gap-6 text-2xl leading-relaxed text-gray-300"
            >
